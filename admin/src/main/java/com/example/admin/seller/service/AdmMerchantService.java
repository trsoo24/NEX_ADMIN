...
import com.example.admin.seller.dto.field.AdmMerchantInfoField;
import com.example.admin.seller.dto.AdmMerchant;
import com.example.admin.seller.mapper.AdmMerchantInfoMapper;
...
public class AdmMerchantService {
    ...
    public void blockMerchant(BlockMerchantDto dto) {
        ...
        List<String> merchantNmList = dto.getSellerNames();
